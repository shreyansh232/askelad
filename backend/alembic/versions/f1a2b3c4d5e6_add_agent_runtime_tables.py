...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_agent_threads_project_id"),
        "agent_threads",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_agent_threads_agent_type"),
        "agent_threads",
        ["agent_type"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_agent_runs_thread_id"), "agent_runs", ["thread_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_runs_project_id"), "agent_runs", ["project_id"], unique=False
    )
    op.create_index(
        op.f("ix_agent_runs_agent_type"), "agent_runs", ["agent_type"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_agent_messages_thread_id"),
        "agent_messages",
        ["thread_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_clarification_requests_thread_id"),
        "clarification_requests",
        ["thread_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clarification_requests_run_id"),
        "clarification_requests",
        ["run_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clarification_requests_project_id"),
        "clarification_requests",
        ["project_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clarification_requests_agent_type"),
        "clarification_requests",
        ["agent_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_clarification_requests_status"),
        "clarification_requests",
        ["status"],
        unique=False,
    )
...
def downgrade() -> None:
    """Downgrade schema."""
    op.drop_index(
        op.f("ix_clarification_requests_status"), table_name="clarification_requests"
    )
    op.drop_index(
        op.f("ix_clarification_requests_agent_type"),
    ...
    op.drop_index(
        op.f("ix_clarification_requests_run_id"), table_name="clarification_requests"
    )
    op.drop_index(
        op.f("ix_clarification_requests_thread_id"), table_name="clarification_requests"
    )
